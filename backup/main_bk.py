...
# ttk.Label(variables_frame, text="Variables (comma separated):").pack(side=tk.LEFT)
# variables_entry = ttk.Entry(variables_frame)
# variables_entry.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(5, 0))
# variables_entry.insert(tk.END, 'a,b,c')  # default value
#
# # Ô nhập bậc
# h = 12
...
# input_poly.insert(tk.END, 'a^5+b^5+c^5+k*(a^4*b+b^4*c+c^4*a)')  # default value
#
# # Ô kết quả
